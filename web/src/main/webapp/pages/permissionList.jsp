    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/permission/roleList">资源权限管理</a></li>
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="刷新"
                                            onclick="location.href='${pageContext.request.contextPath}/permission/permissionList?currentPage=${pageInfo.pageNum}&size=${pageInfo.pageSize}'">
                        ...
                        <form id="updatePermissionList" method="post">
                            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                                ...
                                <tr style="font-size: 12px">
                                    ...
                                    <th class="sorting" name="userName">权限名</th>
                                    <th class="sorting" name="status">url</th>
                                ...
                                <tbody>
                                <c:forEach items="${requestScope.permissionList}" var="permission" varStatus="i">
                                    <tr style="font-size: 12px">
                                        <td><input name="id" type="checkbox" value="${permission.id}"></td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn bg-olive btn-xs"
                                                    onclick='location.href="${pageContext.request.contextPath}/permission/permissionEdit?permId=${permission.id}"'>编辑详情
                                            </button>
                                        </td>
                                    </tr>
                                </c:forEach>
...
<script>
    ...
    $(document).ready(function () {
        ...
        // 激活导航位置
        setSidebarActive("resource-authority");

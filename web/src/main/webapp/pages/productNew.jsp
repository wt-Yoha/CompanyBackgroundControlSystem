...
<body class="skin-yellow sidebar-mini" style="height: auto;">
            ...
            <form id="productInfo" action="${pageContext.request.contextPath}/product/newSubmit" method="post">
                ...
                <div class="box-tools text-center">
                    <button type="button" class="btn bg-maroon"
                            onclick="$('#productInfo').submit()">
                        保存
                    </button>
                    <button type="button" class="btn bg-default"
                            onclick="location.href='${pageContext.request.contextPath}/product/productList';">返回
                    </button>
                </div>
                <!--工具栏/-->
            </form>
